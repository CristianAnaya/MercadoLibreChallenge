...
object ProductFactory {
    ...
    private fun generateAttributeList(size: Int): List<Attribute> {
    ...
    private fun generatePictureList(size: Int): List<Picture> {
    ...
    private fun generatePicture(): Picture {
        return Picture(
            id = DataFactory.getRandomString(),
    ...
    private fun generateInstallments(): Installments {
        return Installments(
    ...
    private fun generateSeller(): Seller {
        return Seller(
            id = DataFactory.getRandomString(),
    ...
    private fun generateShipping(): Shipping {
        return Shipping(
    ...
    private fun generateAttribute(): Attribute {
        return Attribute(
